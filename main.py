...
BALL_IMAGES = [
    pygame.image.load("Media/RED.png"),
    pygame.image.load("Media/GREEN.png"),
    pygame.image.load("Media/BLUE.png"),
    pygame.image.load("Media/YELLOW.png"),
    pygame.image.load("Media/PINK.png"),
    pygame.image.load("Media/ORANGE.png"),
    pygame.image.load("Media/PURPLE.png"),
    pygame.image.load("Media/BOMB.png")
]
SHOOTER_IMAGE = pygame.image.load("Media/CANNON.png")
...
BACKGROUND_MUSIC = "Media/bgmusic.mp3"  
POP_SOUND = "Media/popcork.ogg" 
...
start_image = pygame.image.load("Media/1.png")
game_over_image = pygame.image.load("Media/3.png")
...
class LevelManager:
    def __init__(self):
        self.levels = [
            Level(1, 3, "Media/background1.mp4"),  
            Level(2, 5, "Media/background2.mp4"), 
            Level(3, 7, "Media/background3.mp4") 
        ]
        self.current_level_idx = 0
        self.level_select_image = pygame.image.load("Media/level.png")
